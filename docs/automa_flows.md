...
This folder contains automation flows for the [Automa](https://automa.site/) browser extension. Import the JSON files from `automa_flows/` into the extension to replicate each automation.
