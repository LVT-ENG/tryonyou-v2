...
Run `node scripts/generate_fashion_quote.js` to request a motivational phrase about fashion and art from GPT-4. Set the `OPENAI_API_KEY` environment variable first.
