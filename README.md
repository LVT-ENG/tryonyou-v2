...
## 🔧 Motor Central - Recommendation Engine

The **Motor** is the core recommendation engine implemented as a Google Sheets prototype in `google-apps-script/`. It manages user profiles, body measurements, fashion trends, recommendation rules, and personalized outputs.

**Key features:**
- Users: profiles with style preferences and personal data
- Measurements: body data from TryOn scanner (manual or 3D)
- Trends: Top 20 fashion trends from Google/Fashion Tech Trends
- Rules: weighting algorithm (preferences, trends, fitting)
- Recommendations: 20 personalized results per user
- Lists: catalogs (styles, colors, garment types, fits, etc.)

**Integration options:**
- Google Sheets API via Node.js (see `GoogleSheetsMotor.js`)
- Apps Script Web App (HTTP endpoints)
- CSV export for batch processing
- Zapier/Make.com automations

See full documentation at [google-apps-script/README.md](google-apps-script/README.md).
