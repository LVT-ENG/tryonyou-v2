...
For a quick checklist of what to verify before going live, read
[docs/deployment_review.md](docs/deployment_review.md).
For a condensed reference that links all deployment docs, see
[docs/deployment_overview.md](docs/deployment_overview.md).
If you prefer a single page summary with automation flows and email alerts,
check [docs/deployment_consolidated.md](docs/deployment_consolidated.md).
The codename **Divinity War** (formerly War of Titan) is explained in
[docs/divinity_war.md](docs/divinity_war.md) and will appear in future campaign materials.
To validate SEO tags across all pages, run `python scripts/seo_audit.py`.
