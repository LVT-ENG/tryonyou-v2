...
> **Need help?** Check out our comprehensive [HELP.md](HELP.md) guide for troubleshooting, setup instructions, and common issues.
...
Having issues? Check our [**HELP.md**](HELP.md) guide for:
