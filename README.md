...
## ⚙️ Generate .env automatically
Run `node scripts/generate_env.js` to create a `.env` file with your Vercel organization and project IDs. Set `VERCEL_TOKEN` in your shell before running.
