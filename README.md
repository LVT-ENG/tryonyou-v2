...
To trigger a Make scenario and query GPT‑4 in one step, run `node scripts/automa_make_codex.js` with `MAKE_WEBHOOK_URL` and `OPENAI_API_KEY` defined in your `.env` file.
