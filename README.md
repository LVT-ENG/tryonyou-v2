...
Customize the monitored URL via `SITE_URL`. If the check fails and email
credentials are configured via `SMTP_HOST`, `SMTP_PORT`, `SMTP_USER`, `SMTP_PASS`
and `NOTIFY_EMAIL`, an alert will be sent automatically.
