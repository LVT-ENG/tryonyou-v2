...
The repository is being refactored following a simple **Core / Driver** pattern.
Framework‑agnostic logic now lives under `core/` while scripts and APIs act as
drivers that invoke those functions. See
[docs/core_driver_overview.md](docs/core_driver_overview.md) for details.
