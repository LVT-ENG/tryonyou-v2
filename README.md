...
## 🖼️ 3D Preview Generator
Run `python scripts/generar_modelo_3d.py` to create preview metadata for a clothing item. The function accepts an optional `texture_size` parameter to specify the texture resolution (``"1k"`` by default).
